...
template class DirectfnAlgorithm_ST<QuadrilateralKernel_PlanarVectorSS>;
...
template class DirectfnAlgorithm_ST<QuadrilateralKernel_CurvilinearVectorSS>;
...
template class Triangular_ST<TriangularKernel_RWG_SS>;
